...
/**
 * The player description area on the screen.
 */
public class PlayerDescription extends JPanel {
  ...
  /**
   * Construct a PlayerDescription class.
   */
  public PlayerDescription() {
    ...
    JLabel text = new JLabel("Your Bag");
  ...
  public void refresh(int d, int r, int s, int a) {
    ...
    number[3].setText(a + "");
    if (a == 0) {
      number[3].setForeground(Color.red);
    } else {
      number[3].setForeground(Color.black);
    }
  }
}
